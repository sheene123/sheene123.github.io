...
export const projects = [
  {
    ...
    title: 'Déploiement Cloud sur Kubernetes & FinOps',
    year: '2025 — 2026',
    category: 'DevOps',
    short: "Industrialisation d'une appli web sur Azure AKS : conteneurisation Docker, chaîne CI/CD, monitoring et optimisation des coûts (FinOps).",
    context:
      "Dans le cadre de mon alternance chez Framatome : prendre en charge toute la chaîne de production d'une application web interne (Next.js / Node.js / FastAPI), de la conteneurisation jusqu'à l'exploitation sur un cluster Kubernetes managé Azure (AKS). Objectif : un déploiement fiable, maintenu et maîtrisé côté coûts.",
    missions: [
      "Conteneurisation de l'application avec Docker.",
      'Déploiement et configuration de clusters Kubernetes managés sur Azure (AKS).',
      'Contribution à la chaîne CI/CD et aux mises en production des versions.',
      'Monitoring, maintenance et fiabilisation des services en exploitation.',
      'Optimisation de la consommation des clusters et des coûts cloud (FinOps).',
    ],
    stack: ['Docker', 'Kubernetes', 'Azure AKS', 'CI/CD', 'FinOps', 'Linux'],
  },
  {
