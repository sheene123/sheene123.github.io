export const profile = {
  ...
  about:
    "Étudiant en BUT Informatique à Sorbonne Paris Nord et futur élève-ingénieur en Cloud Computing & Cybersécurité à l'ESILV (Paris La Défense), je travaille aujourd'hui comme alternant Data Analyst & Automation chez Framatome. Mon terrain de jeu : transformer des processus manuels en pipelines automatisés, fiabiliser la donnée et la rendre actionnable — de l'extraction jusqu'au dashboard.",
};
